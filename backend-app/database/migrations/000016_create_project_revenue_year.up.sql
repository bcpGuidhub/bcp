CREATE TABLE IF NOT EXISTS project_revenues_year(
  project_revenues_year_id uuid DEFAULT uuid_generate_v4(),
  project_revenues_id uuid NOT NULL,
  year TEXT NOT NULL,
  ...
  PRIMARY KEY (project_revenues_year_id),
  FOREIGN KEY (project_revenues_id) REFERENCES project_revenues(project_revenues_id) ON DELETE CASCADE
);
