...
import { MessengerRoomAttachment, MessengerRoomGroupParticipant, MessengerRoomOneParticipant } from '..';
...
MessengerConversationParticipants.propTypes = {
  conversation: PropTypes.object.isRequired,
  participants: PropTypes.array.isRequired
};

export default function MessengerConversationParticipants({ conversation, participants }) {
