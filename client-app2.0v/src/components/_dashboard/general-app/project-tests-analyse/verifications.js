export const verificationsFramework = {
  pole_emploi_aid_scheme_for_business_creation: {
      ...
      response: {
        "Le maintien des allocations d'aide au retour à l'emploi": {
          ...
          IS: {
            ...
            'Salaires dirigeant les 24 premiers mois':
    ...
    dependency_tree: {
      project_preparation: {
        current_employment_status: [
          { field: 'Je suis sans emploi', condition: false },
          { field: 'Je suis salarié', condition: true }
        ]
      }
    }
  },
  accumulation_professional_income_retirement_pension: {
  ...
  authorizations_installation_conditions_exercise_professional_activity: {
  ...
  match_profitability_financial_needs: {
    ...
    recommendation: {
      response: {
        "Vous êtes sûr d'avoir fait le bon choix":
          "Vous êtes parvenu à identifier la meilleure solution pour votre projet. Par mesure de sécurité, nous vous conseillons tout de même de faire valider vos choix de création d'entreprise par le professionnel qui vous accompagne.",
        'Vous avez besoin de faire confirmer votre choix':
          "Nous vous recommandons de faire valider vos choix de création d'entreprise par un professionnel. Un expert-comptable bien sensibilisé sur les problématiques de création d'entreprise serait idéal dans votre situation. Compte tenu des nombreux paramètres dont il faut tenir compte, l'analyse d'un expert vous permettra de vous conforter dans vos choix, ou, le cas échéant, d'effectuer les modifications nécessaires. "
      }
    },
    dependency_tree: {}
  },
  social_security_system_contributions: {
    label: 'Votre protection sociale',
    recommendation: {
      response: {
        IR: `
  ...
  social_security_system_contributions_directors: {
    label: 'Votre protection sociale',
    recommendation: {
      response: {
  ...
  match_profitability_financial_needs_director: {
    label: 'Rentabilité de votre projet',
    recommendation: {
      response: {}
    },
...
export const verificationsConditions = {
  pole_emploi_aid_scheme_for_business_creation: {
    conditions: [
      { label: 'Régime fiscal:' },
  ...
  accumulation_professional_income_retirement_pension: {
    conditions: [{ label: 'Votre situation professionnelle :' }]
  },
  match_profitability_financial_needs: {
    conditions: [
  ...
  choice_legal_status: {
    conditions: [{ label: 'Le statut juridique choisi pour votre entreprise :' }]
  },
  social_security_system_contributions: {
    conditions: [{ label: 'Régime fiscal' }]
  },
  social_security_system_contributions_directors: {
    conditions: [{ label: 'Salaires du dirigeant' }]
  },
  initial_financing_plan: {
    conditions: [
      {
...
export const verificationsQuestions = {
  pole_emploi_aid_scheme_for_business_creation: {
    questions: [
      {
  ...
  accumulation_professional_income_retirement_pension: {
    questions: [
      ...
      {
        label:
          "Avez-vous atteint l'âge légal pour partir en retraite (62 ans) et validé suffisammant de trimestre pour avoir la retraite à taux plein, ou atteint l'âge pour percevoir automatiquement la retraite à taux plein (entre 65 et 67 ans pour les assurés nés à partir de 1955) ?",
        responses: ['Oui', 'Non']
      }
    ]
  },
    ...
    questions: [
      {
        ...
        responses: ['des BIC', 'des BNC']
      }
    ]
  }
};
export const verificationsQuestionsSupport = {
  pole_emploi_aid_scheme_for_business_creation: {
    text: {
      node: `
