...
export default function InquistIllustration({ ...other }) {
        ...
        <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
          <g>
            <path
              fill="url(#BG)"
              fillRule="nonzero"
              d="M 0 198.78 c 0 41.458 14.945 79.236 39.539 107.786 c 28.214 32.765 69.128 53.365 114.734 53.434 a 148.44 148.44 0 0 0 56.495 -11.036 c 9.051 -3.699 19.182 -3.274 27.948 1.107 a 75.779 75.779 0 0 0 33.957 8.01 c 5.023 0 9.942 -0.494 14.7 -1.433 c 13.58 -2.67 25.94 -8.99 36.09 -17.94 c 6.378 -5.627 14.547 -8.456 22.897 -8.446 h 0.142 c 27.589 0 53.215 -8.732 139.498 9.738 c 19.021 -13.36 34.554 -31.696 189.006 -5.566 C 474.92 234.58 480 213.388 630 162 c 0 -76.93 -59.774 -139.305 -133.498 -139.305 c -7.516 0 -14.88 0.663 -22.063 1.899 C 305.418 21.42 271.355 0 232.499 0 a 103.651 103.651 0 0 0 -45.88 10.661 c -13.24 6.487 -25.011 15.705 -48.619 11.339 c -32.698 0.544 -62.931 11.69 -119.979 -12.6 C 25.351 97.155 0 144.882 0 198.781 z"
              opacity="0.2"
            />
            <path
              stroke={PRIMARY_MAIN}
            ...
            <text
              x="20"
              y="300"
              style={{ fontFamily: 'Times New Roman', stroke: '#001E3C', fill: '#001E3C', fontSize: '1.2rem' }}
            >
              Community Moderated Q/A for business creators
            </text>
          </g>
        </g>
      </svg>
