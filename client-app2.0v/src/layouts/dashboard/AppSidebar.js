...
import NavSectionAppsSidebar from '../../components/NavSectionAppsSidebar';
import Scrollbar from '../../components/Scrollbar';
import SvgIconStyle from '../../components/SvgIconStyle';
import useCollapseDrawer from '../../hooks/useCollapseDrawer';
import { useSelector } from '../../redux/store';
//
import { sidebarAppDisplay } from './SidebarSolutionsDisplay';
...
export default function AppSidebar() {
  ...
  const renderContent = (
    ...
    >
      <NavSectionAppsSidebar navConfig={sidebarAppDisplay} isShow={!isCollapse} />
    </Scrollbar>
  );
    ...
    >
      <MHidden width="lgUp">
        ...
        >
          <Toolbar />
          <DrawerHeader>
            <Typography sx={{ typography: 'h6' }}>Outils</Typography>
          </DrawerHeader>
          <Divider />
          {renderContent}
        </Drawer>
